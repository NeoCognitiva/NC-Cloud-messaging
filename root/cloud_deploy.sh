...
if ! cf app "$CF_APP"; then
  ...
  cf set-env "$CF_APP" RECEIPTS_QUEUE_TOPIC "$EMAIL_QUEUE_TOPIC"
  ...
  cf set-env "$CF_APP" RABBITMQ_URL "$RD_STATION_TOKEN"
  cf set-env "$CF_APP" RABBITMQ_URL "$ENABLE_RD_STATION"
